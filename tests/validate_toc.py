...
assert metadata["Interface"] == "120100, 120105", "Expected supported Retail interfaces"
assert metadata["Dependencies"] == "DialogueUI, ZygorGuidesViewer", "Both addons are required"
